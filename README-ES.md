Lenguaje: [🇺🇸] [English](README.md) - [🇪🇸] [Español](README-ES.md)
...
const equiman = () => ({
  ...
  trabajé: [ "apache-cordova", "jquery", "bootstrap", ".net", "C#", "ext-net", "sql-server", "mysql", "excel-vba"],
  aprendiendo: [ "english", "react", "next", "testing", "typescript" ]
})
```
